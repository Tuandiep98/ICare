...
class WaveDrinkView extends StatefulWidget {
  @override
  _WaveDrinkViewState createState() => _WaveDrinkViewState();
}

class _WaveDrinkViewState extends State<WaveDrinkView> with TickerProviderStateMixin {
                ...
                children: <Widget>[
                  new Container(
                    decoration: BoxDecoration(
                      color: ICareAppTheme.nearlyDarkBlue.withOpacity(0.5),
                      ...
                      gradient: LinearGradient(
                        colors: [
                          ICareAppTheme.nearlyDarkBlue.withOpacity(0.2),
                          ICareAppTheme.nearlyDarkBlue.withOpacity(0.5)
                        ],
                ...
                children: <Widget>[
                  new Container(
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        colors: [
                          ICareAppTheme.alizarin.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: ICareAppTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: ICareAppTheme.white.withOpacity(
