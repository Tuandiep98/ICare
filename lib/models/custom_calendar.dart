                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: ICareAppTheme.buildLightTheme().dividerColor,
                      ),
                    ),
                    child: Material(
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: ICareAppTheme.buildLightTheme().primaryColor),
            ),
          ),
        ),
      );
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date)
                                  ? ICareAppTheme.buildLightTheme().primaryColor
                                  : Colors.transparent,
                              borderRadius:
                                  const BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
