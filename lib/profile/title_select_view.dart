...
class TitleSelectView extends StatelessWidget {
  ...
  const TitleSelectView({Key key, this.animationController, this.animation,this.title,this.content,this.linkPicture})
      : super(key: key);
